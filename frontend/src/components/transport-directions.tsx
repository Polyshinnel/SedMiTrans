...
const directions = [
  {
    ...
    icon: IconTruck,
    title: 'Автоперевозки',
    description: 'Грузоперевозки автомобильным транспортом по России, СНГ, Европе и Азии.',
  },
  {
    ...
    description: 'Надежная доставка грузов железнодорожным транспортом.',
  },
  {
    ...
    icon: IconPlane,
    title: 'Авиаперевозки',
    description: 'Быстрая доставка грузов самолетом в любую точку мира.',
  },
  {
    ...
    description: 'Экономичная доставка крупногабаритных грузов морским транспортом.',
  },
];
