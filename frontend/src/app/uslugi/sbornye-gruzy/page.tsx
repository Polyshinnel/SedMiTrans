...
export default function ConsolidatedCargoPage() {
  return <>
    <section className={styles.hero} style={{ backgroundImage: "url('/images/oversized-cargo-hero-v2.png')" }} aria-labelledby="oversized-hero-title"><div className={styles.heroOverlay} /><div className={styles.heroContent}><Box className={styles.heroBreadcrumbs}><Anchor href="/" underline="never">Главная</Anchor><span aria-hidden="true">/</span><Anchor href="/uslugi" underline="never">Услуги</Anchor><span aria-hidden="true">/</span><Text component="span">Негабаритные грузы</Text></Box><Title id="oversized-hero-title" order={1} className={styles.heroTitle}>Негабаритные грузы <span>без лишних рисков</span></Title><Text className={styles.heroDescription}>Перевозим промышленное оборудование, строительную технику, крупные конструкции и другие нестандартные грузы. Берём на себя маршрут, технику, крепление и сопровождение.</Text><div className={styles.heroActions}><CalculationRequestModal label="Рассчитать перевозку" size="lg" /></div></div></section>
